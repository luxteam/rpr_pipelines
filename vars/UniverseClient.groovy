    ...
    def createBuild(envs = '', suites = '', updRefs = false, options = null) {
        def request = {
            ...
            if (this.is_parent || (!this.child_of && !this.is_parent)) {
                ...
                this.context.currentBuild.description += "<br><a href='${this.url_map[this.url]}/products/${this.build.job_id}/${this.build.id}/summary' target='_blank'>UMS Report (${this.url_map[this.url]})</a>"
            }
