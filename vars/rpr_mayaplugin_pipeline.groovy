...
def executeTests(String osName, String asicName, Map options)
{
    ...
    try {
        ...
        dir(pathToAssets)
        {
            checkOutBranchOrScm(options['autotest_assets'], "https://gitlab.cts.luxoft.com/autotest_assets/rpr_maya_autotests.git", true, false, true, 'radeonprorender-gitlab', true, false)
        }
